...
Tags: appointment, booking, calender, scheduling, reservation, online scheduler
...
Appointment booking and online scheduling plugin by WP Frank is known for faster and better integration into any WordPress website. Online appointments booking makes sure that you are not lacking at appointments booking and events registration, as well as reminders, confirmations and follow-ups.

== Description ==

Online booking, reservation, appointment scheduling made easy on website by appointment scheduler WordPress plugin.
...
**[Check Live Demo In Action](http://wpfrank.com/demo/appointment-scheduler/)**
...
* Try Live Demo - [Click Here](http://wpfrank.com/demo/appointment-scheduler-pro/)

### Translation Contributed By Our Plugin Users:

* French(fr_FR) by [Adeline Bounma](http://institut-pilote.com)
...
1. Appointment Booking Process - Select Service
2. Appointment Booking Process - Select Date & Go Next
3. Appointment Booking Process - Select Time & Go Next
4. Appointment Booking Process - Signup For Booking
5. Appointment Booking Process - Login If You Have An Account
6. Appointment Booking Process - Confirm You Booking Details
7. Appointment Booking Process - You Booking Done


== Changelog ==

For more information, see [WpFrank](http://wpfrank.com/)
...
= 1.1.9 =
* plugin is reassign to real author @FARAZFRANK
...
- New Feature: Customize the user registration form ( username field, first & last name and skype id )

= 1.1.2 =
- Updated Premium Products Page
...
= 1.0.18 =
- Text domain updated
- Book another appointment button added
- Same id JS problem resolved
- Version Update and Tested upto WP 4.9.8

= 1.0.17 =
- Version Update and Tested upto WP 4.9.8

= 1.0.16 =
- Modify - At dashboard change Style of Badges of appointment , status ..etc   for clear readability.
- Modify - Remove next button from details tab at frontend [Reason - User Confusion]
- Modify - Range Slider for logo width,height in appearance tab
- Bug Fixed - Remove Double slash error in enqueue style
- Add Our Product Page 
- Add Rating Bar in plugins detail page
- Version Update and Tested upto WP 4.9.7 
 
= 1.0.15 -  CSS Bug fixed, Bugs Fixed, Misspelled words fixed + WP 4.9.6 tested + 15% Off Coupon Added
= 1.0.14 -  Previous commit not working 
= 1.0.13 -  Syntax bug fixed in array_unshift + WP 4.9.4 tested 
= 1.0.12 - plugin readme update
= 1.0.11 - Version Update + WP 4.9.4 tested + Typos fix
= 1.0.10 - Version Update + WP 4.9.1 tested
= 1.0.9 - E-Mail Header added + WP 4.9 tested
= 1.0.8.8 - Version Update
= 1.0.8.7 - Version Update + WP 4.8.2 tested
= 1.0.8.6 - Version Update + direct setting link added
= 1.0.8.5 - plugin Greek (el) language completely translated by an contributor
= 1.0.8.4 - new language contirbution added into plugin Greek (el) by A User
= 1.0.8.3 - new language contirbution added into plugin Deutsch (Schweiz, Du_de) by Thomas Singler
= 1.0.8.2 - compatible upto 4.8.1 and new language translation added
= 1.0.8.1 - Install script error fixed
= 1.0.8 =
- All Code indented
- Multilingual & Translation Ready
- Compatible with Admin Custom Login
- Business logo issue on fresh install
- Business Settings Not Showing Properly + Text Removed and Icon Added
- Multiple All Day OFF Conflicting DatePicker on Frontend
- Add Holidays JS Validation 
- Add Holidays Default Value Added
- Update Holidays Default Value Added
- On Peding and Approved appointments timeslots will be disable
= 1.0.7 =
- WpFrank theme compatibility issue fix
= 1.0.6 =
- version update
= 1.0.5 =
- version update
= 1.0.4 =
- uninstallation bug fixed
= 1.0.3 =
...
- Notification msg back slashes fixed
- Few Code Indented
= 1.0.0 Version =
- New: Dashboard
- New: Plugin Menu
...
You can find [docs](http://wpfrank.com/docs/), [FAQ](http://wpfrank.com/faq/) and more detailed information about Appointment Scheduler on [WpFrank](http://wpfrank.com). If you were unable to find the answer to your question on the FAQ or in any of the documentation, you should check the [support forum](https://wordpress.org/plugins/appointment-scheduler-weblizar/) on WordPress.org.

= We Need Your Support =

It is really hard to continue development and support for this free plugin without contributions from users like you. If you are enjoying using our Appointment Scheduler plugin and find it useful, then please consider [__Making a Donation__](http://wpfrank.com). Your donation will help us to encourage and support the plugin's continued development and better user support.

= Translators =

Please contribute to translate our plugin.  Contact at `contact (at) wpfrank (dot) com`.

== Frequently Asked Questions ==

Please use WordPress [support forum](https://wordpress.org/plugins/appointment-scheduler-weblizar/) to ask any query regarding any issue.
