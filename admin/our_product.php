<?php
	...
	wp_enqueue_style('ap_bootstrap_min_product',WPFRANK_A_P_SYSTEM.'/bootstrap/bootstrap.min-product.css' , array() ,true);
	wp_enqueue_style('ap_fontawesome_latest',WPFRANK_A_P_SYSTEM.'/font-awesome-latest/css/fontawesome-all.min.css' , array() ,true);
?>
<div class="container col-container p-3">
	<div class="row text-center">
		<div class="col-sm-12 col-md-12">
			<img width="200" src="https://wpfrank.com//wp-content/uploads/2016/04/logo.png" />
